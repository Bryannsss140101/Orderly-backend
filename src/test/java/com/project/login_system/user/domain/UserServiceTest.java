...
public class UserServiceTest {
         ...
         * .hasMessageContaining("Resource not found with %d", 99L);
         * 
         ...
         * .isInstanceOf(ResourceNotFoundException.class)
         * .hasMessageContaining("Resource not found with Username");
         * 
         ...
         * 
         * @Test
         * void shouldUpdateAndReturnUserResponseDtoWhenRequestIsValid() {
         * when(userRepository.findById(userId))
         * .thenReturn(Optional.of(testUser));
         * 
         * when(userRepository.existsByEmail(testRegisterRequestDto.getEmail()))
         * .thenReturn(false);
         * 
         * when(userRepository.existsByUsername(testRegisterRequestDto.getUsername()))
         * .thenReturn(false);
         * 
         * when(modelMapper.map(testUser, UserResponseDto.class))
         * .thenReturn(testUserResponseDto);
         * 
         * var result = userService.update(userId, testRegisterRequestDto);
         * 
         * assertThat(result).isNotNull();
         * assertThat(result.getId()).isEqualTo(userId);
         * assertThat(result.getUsername()).isEqualTo(userUsername);
         ...
         * .thenReturn(Optional.empty());
         * 
         * assertThatThrownBy(() -> userService.update(userId, testRegisterRequestDto))
         * .isInstanceOf(ResourceNotFoundException.class);
         * 
